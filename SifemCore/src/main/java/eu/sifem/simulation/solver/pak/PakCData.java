...
public class PakCData {
	...
	public Map<String, Map<String, String>> card12_1_a_materialCommon = new HashMap<String, Map<String, String>>();	
	...
	public Map<String, Map<String, String>> card13_1_b = new HashMap<String, Map<String, String>>();	
	public Map<String, String> card14 = new HashMap<String, String>();
	public Map<String, Map<String, String>> card14_1 = new HashMap<String, Map<String, String>>();	
