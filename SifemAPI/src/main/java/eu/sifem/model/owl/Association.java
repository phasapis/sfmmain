 ...
 * Source Class: Association <br>
 * @version generated on Mon May 11 16:25:20 BST 2015 by jbjares
 */

public interface Association extends AgentInfluence {
    ...
    /* ***************************************************
     * Property http://www.w3.org/ns/prov#hadPlan
     */
     
    /**
     * Gets all property values for the hadPlan property.<p>
     * 
     * @returns a collection of values for the hadPlan property.
     */
    Collection<? extends Plan> getHadPlan();

    /**
     * Checks if the class has a hadPlan property value.<p>
     * 
     * @return true if there is a hadPlan property value.
     */
    boolean hasHadPlan();

    /**
     * Adds a hadPlan property value.<p>
     * 
     * @param newHadPlan the hadPlan property value to be added
     */
    void addHadPlan(Plan newHadPlan);

    /**
     * Removes a hadPlan property value.<p>
     * 
     * @param oldHadPlan the hadPlan property value to be removed.
     */
    void removeHadPlan(Plan oldHadPlan);
