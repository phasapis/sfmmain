 ...
 * Source Class: DefaultEnvironmentalTemperature <br>
 * @version generated on Mon May 11 16:25:17 BST 2015 by jbjares
 */
public class DefaultEnvironmentalTemperature extends WrappedIndividualImpl implements EnvironmentalTemperature {

    public DefaultEnvironmentalTemperature(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
    }
    ...
    public Collection<? extends Temperature> getTemperature() {
        return getDelegate().getPropertyValues(getOwlIndividual(),
                                               Vocabulary.OBJECT_PROPERTY_TEMPERATURE,
    ...
    public void removeTemperature(Temperature oldTemperature) {
