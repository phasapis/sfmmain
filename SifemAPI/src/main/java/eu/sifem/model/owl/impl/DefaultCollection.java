...
import eu.sifem.model.owl.Agent;
import eu.sifem.model.owl.Attribution;
import eu.sifem.model.owl.Derivation;
import eu.sifem.model.owl.Entity;
import eu.sifem.model.owl.Generation;
import eu.sifem.model.owl.Invalidation;
import eu.sifem.model.owl.PrimarySource;
import eu.sifem.model.owl.Quotation;
import eu.sifem.model.owl.Revision;
 ...
 */
public class DefaultCollection extends WrappedIndividualImpl {
    ...
    public Collection<? extends Entity> getHadMember() {
        return getDelegate().getPropertyValues(getOwlIndividual(),
                                               Vocabulary.OBJECT_PROPERTY_HADMEMBER,
                                               DefaultEntity.class);
    }
    ...
    public void addHadMember(Entity newHadMember) {
        getDelegate().addPropertyValue(getOwlIndividual(),
                                       Vocabulary.OBJECT_PROPERTY_HADMEMBER,
                                       newHadMember);
    }

    public void removeHadMember(Entity oldHadMember) {
        getDelegate().removePropertyValue(getOwlIndividual(),
                                          Vocabulary.OBJECT_PROPERTY_HADMEMBER,
                                          oldHadMember);
    }
