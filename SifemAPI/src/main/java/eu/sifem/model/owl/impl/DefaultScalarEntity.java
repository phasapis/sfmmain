 ...
 * Source Class: DefaultScalarEntity <br>
 * @version generated on Mon May 11 16:25:20 BST 2015 by jbjares
 */
public class DefaultScalarEntity extends WrappedIndividualImpl implements ScalarEntity {

    public DefaultScalarEntity(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
    }
    ...
    public Collection<? extends ScalarValue> getHasScalarValue() {
        return getDelegate().getPropertyValues(getOwlIndividual(),
                                               Vocabulary.OBJECT_PROPERTY_HASSCALARVALUE,
                                               DefaultScalarValue.class);
    }

    public boolean hasHasScalarValue() {
	   return !getHasScalarValue().isEmpty();
    }

    public void addHasScalarValue(ScalarValue newHasScalarValue) {
        getDelegate().addPropertyValue(getOwlIndividual(),
                                       Vocabulary.OBJECT_PROPERTY_HASSCALARVALUE,
                                       newHasScalarValue);
    }

    public void removeHasScalarValue(ScalarValue oldHasScalarValue) {
