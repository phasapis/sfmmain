 ...
 * Source Class: DefaultPressure_Dimension <br>
 * @version generated on Mon May 11 16:25:20 BST 2015 by jbjares
 */
public class DefaultPressure_Dimension extends WrappedIndividualImpl implements Pressure_Dimension {

    public DefaultPressure_Dimension(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
    }
