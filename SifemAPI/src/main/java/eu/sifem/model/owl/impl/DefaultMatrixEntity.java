 ...
 * Source Class: DefaultMatrixEntity <br>
 * @version generated on Mon May 11 16:25:20 BST 2015 by jbjares
 */
public class DefaultMatrixEntity extends WrappedIndividualImpl implements MatrixEntity {

    public DefaultMatrixEntity(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
    }
    ...
    public Collection<? extends MatrixValue> getHasMatrixValue() {
        return getDelegate().getPropertyValues(getOwlIndividual(),
                                               Vocabulary.OBJECT_PROPERTY_HASMATRIXVALUE,
                                               DefaultMatrixValue.class);
    }

    public boolean hasHasMatrixValue() {
	   return !getHasMatrixValue().isEmpty();
    }

    public void addHasMatrixValue(MatrixValue newHasMatrixValue) {
        getDelegate().addPropertyValue(getOwlIndividual(),
                                       Vocabulary.OBJECT_PROPERTY_HASMATRIXVALUE,
                                       newHasMatrixValue);
    }

    public void removeHasMatrixValue(MatrixValue oldHasMatrixValue) {
