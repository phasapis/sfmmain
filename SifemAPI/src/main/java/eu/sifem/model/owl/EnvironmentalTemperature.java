 ...
 * Source Class: EnvironmentalTemperature <br>
 * @version generated on Mon May 11 16:25:17 BST 2015 by jbjares
 */

public interface EnvironmentalTemperature extends Environment {

    /* ***************************************************
     * Property http://codata.jp/OML-Environment.owl#Temperature
     */
     
    /**
     * Gets all property values for the Temperature property.<p>
     * 
     * @returns a collection of values for the Temperature property.
     */
    Collection<? extends Temperature> getTemperature();

    /**
     * Checks if the class has a Temperature property value.<p>
     * 
     * @return true if there is a Temperature property value.
     */
    boolean hasTemperature();

    /**
     * Adds a Temperature property value.<p>
     * 
     * @param newTemperature the Temperature property value to be added
     */
    void addTemperature(Temperature newTemperature);

    /**
     * Removes a Temperature property value.<p>
     * 
     * @param oldTemperature the Temperature property value to be removed.
     */
    void removeTemperature(Temperature oldTemperature);
