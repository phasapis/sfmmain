 ...
 * Source Class: MatrixEntity <br>
 * @version generated on Mon May 11 16:25:20 BST 2015 by jbjares
 */

public interface MatrixEntity extends Entity {

    /* ***************************************************
     * Property http://www.sifemontologies.com/ontologies/Simulation.owl#hasMatrixValue
     */
     
    /**
     * Gets all property values for the hasMatrixValue property.<p>
     * 
     * @returns a collection of values for the hasMatrixValue property.
     */
    Collection<? extends MatrixValue> getHasMatrixValue();

    /**
     * Checks if the class has a hasMatrixValue property value.<p>
     * 
     * @return true if there is a hasMatrixValue property value.
     */
    boolean hasHasMatrixValue();

    /**
     * Adds a hasMatrixValue property value.<p>
     * 
     * @param newHasMatrixValue the hasMatrixValue property value to be added
     */
    void addHasMatrixValue(MatrixValue newHasMatrixValue);

    /**
     * Removes a hasMatrixValue property value.<p>
     * 
     * @param oldHasMatrixValue the hasMatrixValue property value to be removed.
     */
    void removeHasMatrixValue(MatrixValue oldHasMatrixValue);
