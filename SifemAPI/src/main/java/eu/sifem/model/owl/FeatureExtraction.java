 ...
 * Source Class: FeatureExtraction <br>
 * @version generated on Mon May 11 16:25:20 BST 2015 by jbjares
 */

public interface FeatureExtraction extends DataAnalysis {

    /* ***************************************************
     * Property http://www.sifemontologies.com/ontologies/Simulation.owl#extractsDataFeature
     */
     
    /**
     * Gets all property values for the extractsDataFeature property.<p>
     * 
     * @returns a collection of values for the extractsDataFeature property.
     */
    Collection<? extends WrappedIndividual> getExtractsDataFeature();

    /**
     * Checks if the class has a extractsDataFeature property value.<p>
     * 
     * @return true if there is a extractsDataFeature property value.
     */
    boolean hasExtractsDataFeature();

    /**
     * Adds a extractsDataFeature property value.<p>
     * 
     * @param newExtractsDataFeature the extractsDataFeature property value to be added
     */
    void addExtractsDataFeature(WrappedIndividual newExtractsDataFeature);

    /**
     * Removes a extractsDataFeature property value.<p>
     * 
     * @param oldExtractsDataFeature the extractsDataFeature property value to be removed.
     */
    void removeExtractsDataFeature(WrappedIndividual oldExtractsDataFeature);
