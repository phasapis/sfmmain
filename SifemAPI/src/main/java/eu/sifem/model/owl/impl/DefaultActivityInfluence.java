 ...
 * Source Class: DefaultActivityInfluence <br>
 * @version generated on Mon May 11 16:25:20 BST 2015 by jbjares
 */
public class DefaultActivityInfluence extends WrappedIndividualImpl implements ActivityInfluence {

    public DefaultActivityInfluence(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
    }
    ...
    public Collection<? extends Activity> getActivity() {
        return getDelegate().getPropertyValues(getOwlIndividual(),
                                               Vocabulary.OBJECT_PROPERTY_ACTIVITY,
