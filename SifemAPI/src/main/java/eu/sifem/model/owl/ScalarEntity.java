 ...
 * Source Class: ScalarEntity <br>
 * @version generated on Mon May 11 16:25:20 BST 2015 by jbjares
 */

public interface ScalarEntity extends Entity {

    /* ***************************************************
     * Property http://www.sifemontologies.com/ontologies/Simulation.owl#hasScalarValue
     */
     
    /**
     * Gets all property values for the hasScalarValue property.<p>
     * 
     * @returns a collection of values for the hasScalarValue property.
     */
    Collection<? extends ScalarValue> getHasScalarValue();

    /**
     * Checks if the class has a hasScalarValue property value.<p>
     * 
     * @return true if there is a hasScalarValue property value.
     */
    boolean hasHasScalarValue();

    /**
     * Adds a hasScalarValue property value.<p>
     * 
     * @param newHasScalarValue the hasScalarValue property value to be added
     */
    void addHasScalarValue(ScalarValue newHasScalarValue);

    /**
     * Removes a hasScalarValue property value.<p>
     * 
     * @param oldHasScalarValue the hasScalarValue property value to be removed.
     */
    void removeHasScalarValue(ScalarValue oldHasScalarValue);
