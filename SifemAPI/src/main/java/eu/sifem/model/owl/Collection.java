...
public interface Collection extends Entity {
     ...
     */
    List<? extends Entity> getAlternateOf();
    ...
    /* ***************************************************
     * Property http://www.w3.org/ns/prov#hadMember
     */
     
    /**
     * Gets all property values for the hadMember property.<p>
     * 
     * @returns a collection of values for the hadMember property.
     */
    List<? extends Entity> getHadMember();

    /**
     * Checks if the class has a hadMember property value.<p>
     * 
     * @return true if there is a hadMember property value.
     */
    boolean hasHadMember();

    /**
     * Adds a hadMember property value.<p>
     * 
     * @param newHadMember the hadMember property value to be added
     */
    void addHadMember(Entity newHadMember);

    /**
     * Removes a hadMember property value.<p>
     * 
     * @param oldHadMember the hadMember property value to be removed.
     */
    void removeHadMember(Entity oldHadMember);
     ...
     */
    List<? extends Entity> getHadPrimarySource();
     ...
     */
    List<? extends Attribution> getQualifiedAttribution();
     ...
     */
    List<? extends Derivation> getQualifiedDerivation();
     ...
     */
    List<? extends Generation> getQualifiedGeneration();
     ...
     */
    List<? extends Invalidation> getQualifiedInvalidation();
     ...
     */
    List<? extends PrimarySource> getQualifiedPrimarySource();
     ...
     */
    List<? extends Quotation> getQualifiedQuotation();
     ...
     */
    List<? extends Revision> getQualifiedRevision();
     ...
     */
    List<? extends Entity> getSpecializationOf();
     ...
     */
    List<? extends Agent> getWasAttributedTo();
     ...
     */
    List<? extends Entity> getWasDerivedFrom();
     ...
     */
    List<? extends Activity> getWasGeneratedBy();
     ...
     */
    List<? extends Activity> getWasInvalidatedBy();
     ...
     */
    List<? extends Entity> getWasQuotedFrom();
     ...
     */
    List<? extends Entity> getWasRevisionOf();
     ...
     */
    List<? extends Object> getGeneratedAtTime();
     ...
     */
    List<? extends Object> getInvalidatedAtTime();
