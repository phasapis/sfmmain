 ...
 * Source Class: Visualisation <br>
 * @version generated on Mon May 11 16:25:20 BST 2015 by jbjares
 */

public interface Visualisation extends Activity {
    ...
    /* ***************************************************
     * Property http://www.sifemontologies.com/ontologies/Simulation.owl#usesDataFeature
     */
     
    /**
     * Gets all property values for the usesDataFeature property.<p>
     * 
     * @returns a collection of values for the usesDataFeature property.
     */
    Collection<? extends WrappedIndividual> getUsesDataFeature();

    /**
     * Checks if the class has a usesDataFeature property value.<p>
     * 
     * @return true if there is a usesDataFeature property value.
     */
    boolean hasUsesDataFeature();

    /**
     * Adds a usesDataFeature property value.<p>
     * 
     * @param newUsesDataFeature the usesDataFeature property value to be added
     */
    void addUsesDataFeature(WrappedIndividual newUsesDataFeature);

    /**
     * Removes a usesDataFeature property value.<p>
     * 
     * @param oldUsesDataFeature the usesDataFeature property value to be removed.
     */
    void removeUsesDataFeature(WrappedIndividual oldUsesDataFeature);
