 ...
 * Source Class: DefaultAssociation <br>
 * @version generated on Mon May 11 16:25:20 BST 2015 by jbjares
 */
public class DefaultAssociation extends WrappedIndividualImpl implements Association {

    public DefaultAssociation(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
    }
    ...
    public Collection<? extends Plan> getHadPlan() {
        return getDelegate().getPropertyValues(getOwlIndividual(),
                                               Vocabulary.OBJECT_PROPERTY_HADPLAN,
                                               DefaultPlan.class);
    }
    ...
    public void addHadPlan(Plan newHadPlan) {
        getDelegate().addPropertyValue(getOwlIndividual(),
                                       Vocabulary.OBJECT_PROPERTY_HADPLAN,
                                       newHadPlan);
    }

    public void removeHadPlan(Plan oldHadPlan) {
        getDelegate().removePropertyValue(getOwlIndividual(),
                                          Vocabulary.OBJECT_PROPERTY_HADPLAN,
                                          oldHadPlan);
    }
