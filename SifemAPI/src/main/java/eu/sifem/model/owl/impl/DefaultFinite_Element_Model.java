 ...
 * Source Class: DefaultFinite_Element_Model <br>
 * @version generated on Mon May 11 16:25:20 BST 2015 by jbjares
 */
public class DefaultFinite_Element_Model extends WrappedIndividualImpl implements Finite_Element_Model {

    public DefaultFinite_Element_Model(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
    }
    ...
    public Collection<? extends FiniteElementModelSettings> getHasFiniteElementModelSettings() {
        return getDelegate().getPropertyValues(getOwlIndividual(),
                                               Vocabulary.OBJECT_PROPERTY_HASFINITEELEMENTMODELSETTINGS,
                                               DefaultFiniteElementModelSettings.class);
    }

    public boolean hasHasFiniteElementModelSettings() {
	   return !getHasFiniteElementModelSettings().isEmpty();
    }

    public void addHasFiniteElementModelSettings(FiniteElementModelSettings newHasFiniteElementModelSettings) {
        getDelegate().addPropertyValue(getOwlIndividual(),
                                       Vocabulary.OBJECT_PROPERTY_HASFINITEELEMENTMODELSETTINGS,
                                       newHasFiniteElementModelSettings);
    }

    public void removeHasFiniteElementModelSettings(FiniteElementModelSettings oldHasFiniteElementModelSettings) {
        getDelegate().removePropertyValue(getOwlIndividual(),
                                          Vocabulary.OBJECT_PROPERTY_HASFINITEELEMENTMODELSETTINGS,
                                          oldHasFiniteElementModelSettings);
    }
