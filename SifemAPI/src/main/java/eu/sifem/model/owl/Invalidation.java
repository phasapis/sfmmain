 ...
 * Source Class: Invalidation <br>
 * @version generated on Mon May 11 16:25:20 BST 2015 by jbjares
 */

public interface Invalidation extends InstantaneousEvent, ActivityInfluence {

    /* ***************************************************
     * Property http://www.w3.org/ns/prov#activity
     */
     
    /**
     * Gets all property values for the activity property.<p>
     * 
     * @returns a collection of values for the activity property.
     */
    Collection<? extends Activity> getActivity();

    /**
     * Checks if the class has a activity property value.<p>
     * 
     * @return true if there is a activity property value.
     */
    boolean hasActivity();

    /**
     * Adds a activity property value.<p>
     * 
     * @param newActivity the activity property value to be added
     */
    void addActivity(Activity newActivity);

    /**
     * Removes a activity property value.<p>
     * 
     * @param oldActivity the activity property value to be removed.
     */
    void removeActivity(Activity oldActivity);
